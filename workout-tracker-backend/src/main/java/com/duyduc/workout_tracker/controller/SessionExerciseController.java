...
public class SessionExerciseController {
    ...
    public ResponseEntity<SessionExerciseResponse> createSessionExercise(
            ...
            @RequestBody SessionExerciseRequest request,
            @AuthenticationPrincipal UserPrincipal user) {
        SessionExerciseResponse response = sessionExerciseService.createSessionExercise(request, sessionId, planId,
                user.getUserId());
    ...
    public ResponseEntity<SessionExerciseResponse> updateSessionExercise(
            ...
            @RequestBody SessionExerciseRequest request,
            @AuthenticationPrincipal UserPrincipal user) {
        SessionExerciseResponse response = sessionExerciseService.updateSessionExercise(request, id, sessionId, planId,
                user.getUserId());
        return ResponseEntity.ok(response);
    }
